...
const GOALS = [
  ...
  { label: "Travel and get around easily", icon: "M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
      ...
      {step === 1 && (
        <div className="space-y-4">
          <div className="text-center space-y-1">
            <h1
              className="text-[22px] font-bold text-[var(--text)] tracking-tight"
              style={{ fontFamily: "var(--font-montserrat)" }}
            >
              Why are you learning English?
            </h1>
            <p className="text-[var(--text-2)] text-[13px]">
              We&apos;ll personalise your practice around your goal
            </p>
          </div>
          ...
          <Button variant="primary" size="lg" className="w-full" disabled={!goal} onClick={() => setStep(2)}>
            Continue
          </Button>
        </div>
      )}
      ...
      {step === 2 && (
        <div className="space-y-5">
          <div className="text-center space-y-1">
            ...
            <p className="text-[var(--text-2)] text-[13px]">We&apos;ll start you at the right pace</p>
          </div>
                ...
                <div>
                  <div
                    className={`text-[15px] font-semibold capitalize ${
                      level === l.id ? "text-white" : "text-[var(--text)]"
                    }`}
                  >
                    {l.label}
                  </div>
                  <div
                    className={`text-[12px] mt-0.5 ${
                      level === l.id ? "text-white/75" : "text-[var(--text-2)]"
                    }`}
                  >
                    {l.desc}
                  </div>
